        ...
        <div>
            <div className="grid grid-cols-5 gap-8">
                <Button className="hover:scale-105 w-60 bg-white p-5 ring-2 ring-gray-100 rounded-xl shadow-xl h-20 hover:bg-transparent">
                    <Link to='https://easternborderasset-web.vercel.app/recommend?category=house' className="justify-between flex items-center gap-10">
                    <img src={houseicon} width={50} />
                    <h1 className="text-blue-800 text-xl font-bold">{t("house")}</h1>
                    </Link>
                </Button>
                <Button className="hover:scale-105 w-60 bg-white p-5 ring-2 ring-gray-100 rounded-xl shadow-xl h-20 hover:bg-transparent">
                    <Link to='https://easternborderasset-web.vercel.app/recommend?category=condo' className="justify-between flex items-center gap-10">
                    <img src={condoicon} width={50} />
                    <h1 className="text-blue-800 text-xl font-bold">{t("condo")}</h1>
                    </Link>
                </Button>
                <Button className="hover:scale-105 w-60 bg-white p-5 ring-2 ring-gray-100 rounded-xl shadow-xl h-20 hover:bg-transparent">
                    <Link to='https://easternborderasset-web.vercel.app/recommend?category=land' className="justify-between flex items-center gap-10">
                    <img src={landicon} width={50} />
                    <h1 className="text-blue-800 text-xl font-bold">{t("land")}</h1>
                    </Link>
                </Button>
                <Button className=" hover:scale-105 w-60 bg-white p-5 ring-2 ring-gray-100 rounded-xl shadow-xl h-20 hover:bg-transparent">
                    <Link to='https://easternborderasset-web.vercel.app/recommend?category=commercial-building' className="justify-between flex items-center gap-10">
                    <img src={commercialbuildingicon} width={50} />
                    <h1 className="text-blue-800 text-xl font-bold">{t("commercial")}<br/>{t("building")}</h1>
                    </Link>
                </Button>
                <Button className="hover:scale-105 w-60 bg-white p-5 ring-2 ring-gray-100 rounded-xl shadow-xl h-20 hover:bg-transparent">
                    <Link to='https://easternborderasset-web.vercel.app/recommend?category=townhouse' className="justify-between flex items-center gap-10">
